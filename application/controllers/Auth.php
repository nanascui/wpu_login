...
class Auth extends CI_Controller
{
    ...
    //login//
    {
        ...
        $this->form_validation->set_rules('password', 'Paswordd', 'trim|required');
    ...
    public function resetPassword()
    {
        ...
        if ($user) 
        {
            ...
            } else 
            {
                ...
                alert alert-danger" role="alert">Reset password failed!! Wrong token.</div>');
                redirect('auth');
            }
            
        } else {
            $this->session->set_flashdata('message', '<div class="
            alert alert-danger" role="alert">Reset password failed!! Wrong email.</div>');
            redirect('auth');
        }
    }
